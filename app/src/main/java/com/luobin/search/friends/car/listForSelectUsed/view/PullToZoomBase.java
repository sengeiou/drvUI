package com.luobin.search.friends.car.listForSelectUsed.view;
...
public abstract class PullToZoomBase<T extends View> extends LinearLayout implements IPullToZoom<T> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            //初始化状态View
            TypedArray a = getContext().obtainStyledAttributes(attrs, PullToZoomView);

            int zoomViewResId = a.getResourceId(PullToZoomView_zoomView, 0);
            if (zoomViewResId > 0) {
                mZoomView = mLayoutInflater.inflate(zoomViewResId, null, false);
            }

            int headerViewResId = a.getResourceId(PullToZoomView_headerView, 0);
            if (headerViewResId > 0) {
                mHeaderView = mLayoutInflater.inflate(headerViewResId, null, false);
            }

            isParallax = a.getBoolean(PullToZoomView_isHeaderParallax, true);
    ...
    /**
     * <p>This symbol is the offset where the {@link com.luobin.mobassist.R.attr#contentView}
     ...
     *
     * @attr name com.luobin.mobassist:contentView
     */
    public static final int PullToZoomView_contentView = 1;
    /**
     * <p>This symbol is the offset where the {@link com.luobin.mobassist.R.attr#headerView}
     * attribute's value can be found in the {@link #PullToZoomView} array.
     * <p>
     * <p>
     * <p>Must be a reference to another resource, in the form "<code>@[+][<i>package</i>:]<i>type</i>:<i>name</i></code>"
     * or to a theme attribute in the form "<code>?[<i>package</i>:][<i>type</i>:]<i>name</i></code>".
     *
     * @attr name com.luobin.mobassist:headerView
     */
    public static final int PullToZoomView_headerView = 0;
    /**
     * <p>This symbol is the offset where the {@link com.luobin.mobassist.R.attr#isHeaderParallax}
     * attribute's value can be found in the {@link #PullToZoomView} array.
     * <p>
     * <p>
     ...
     *
     * @attr name com.luobin.mobassist:isHeaderParallax
     */
    public static final int PullToZoomView_isHeaderParallax = 3;
    /**
     * <p>This symbol is the offset where the {@link com.luobin.mobassist.R.attr#zoomView}
     * attribute's value can be found in the {@link #PullToZoomView} array.
     * <p>
     * <p>
     * <p>Must be a reference to another resource, in the form "<code>@[+][<i>package</i>:]<i>type</i>:<i>name</i></code>"
     * or to a theme attribute in the form "<code>?[<i>package</i>:][<i>type</i>:]<i>name</i></code>".
     *
     * @attr name com.luobin.mobassist:zoomView
     */
