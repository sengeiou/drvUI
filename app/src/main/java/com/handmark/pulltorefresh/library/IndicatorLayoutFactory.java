...
public class IndicatorLayoutFactory {
	 ...
	 */
	public static IndicatorLayout createIndicatorLayout(String layoutCode, Context context, Mode mode) {
	...
	private static class DefaultIndicatorLayoutFactory {
		 ...
		 */
		public static IndicatorLayout createIndicatorLayout(Class<? extends IndicatorLayout> clazz, Context context, Mode mode) {
