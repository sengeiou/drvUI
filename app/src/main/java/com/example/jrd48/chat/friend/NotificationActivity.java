...
//    private EditText etSearch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.friends_new);
        mContext = this;
...
//                        }
    ...
    public class FriendRequestAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (friendsMsg.getType() != null && friendsMsg.getType().length() > 0) {
                convertView = LayoutInflater.from(context).inflate(R.layout.friend_team_index, null);
                ...
                convertView = layoutInflater.inflate(R.layout.friends_new_list_item, null);
                ...
                if (friendsMsg.getTypePic().equals(teamType)) {
                    ...
                    if (type == ProtoMessage.ApplyTeamType.attApply_VALUE) {
                        ...
                        style.setSpan(new ForegroundColorSpan(Color.BLACK), 0, friendsMsg.getUserName().length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
                    ...
                    style.setSpan(new ForegroundColorSpan(Color.BLACK), 2, friendsMsg.getUserName().length() + 2, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
     ...
     * @return
     */
    public Bitmap getUserFace(FriendsAndTeams param) {
        Bitmap bmp = null;
        try {
            ...
            if (bmp == null) {
                ...
                bmp = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.default_useravatar);
            }
    ...
    private void dialogFriendsRequest(final int position, final FriendsAndTeams friendsMsg) {
        ...
        new AlertDialog.Builder(mContext, AlertDialog.THEME_HOLO_LIGHT).setTitle("设置备注")// 提示框标题
    ...
    public void refuseAdd(final int position, final FriendsAndTeams friendsMsg) {
        AlertDialog.Builder builder = new AlertDialog.Builder(mContext, AlertDialog.THEME_HOLO_LIGHT); // 先得到构造器
