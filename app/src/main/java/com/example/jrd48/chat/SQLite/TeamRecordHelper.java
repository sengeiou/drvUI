...
public class TeamRecordHelper extends SQLiteOpenHelper {
    public static final String TEAM_RECORD = "create table TeamRecord("
    ...
    public TeamRecordHelper(Context context, String name, SQLiteDatabase.CursorFactory factory) {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL(TEAM_RECORD);
