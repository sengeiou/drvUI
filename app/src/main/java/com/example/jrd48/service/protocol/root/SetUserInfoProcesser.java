...
public class SetUserInfoProcesser extends CommonProcesser{
    public final static String ACTION = "ACTION.SetUserInfoProcesser";

    public SetUserInfoProcesser(Context context) {
        super(context);
    }
