...
public class InviteJoinGroupProcesser extends CommonProcesser {
    public final static String ACTION = "ACTION.InviteJoinGroupProcesser";

    public InviteJoinGroupProcesser(Context context) {
        super(context);
    }
    @Override
    public void onGot(byte[] data) {
        Log.i("chat", "got InviteJoinGroup answer: ");
        try {
