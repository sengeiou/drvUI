...
public class UploadProcesser extends CommonProcesser {
    public final static String ACTION = "ACTION.UploadProcesser";
    ...
    public void onGot(byte[] data) {
        try {
            ...
            Log.i("pocdemo", "上传应答: " + resp.getErrorCode() + ", resp msg_id:" + resp.getMsgID());
