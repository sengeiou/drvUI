...
public class ApplyGroupProcesser extends CommonProcesser {
    public final static String ACTION = "ACTION.ApplyGroupProcesser";

    public ApplyGroupProcesser(Context context) {
        super(context);
    }
    @Override
    public void onGot(byte[] data) {
        Log.i("chat", "邀请或者申请加群应答.");
        try {
