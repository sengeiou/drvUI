        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_START:
                    ...
                    LogTools.d("RESRtmpSender,open url=" + (String) msg.obj);
                    jniRtmpPointer = RtmpClient.open((String) msg.obj, true);
                    LogTools.d("RESRtmpSender,jniRtmpPointer=" + jniRtmpPointer);
                ...
                case MSG_WRITE:
                    ...
                    this.sendEmptyMessageDelayed(MSG_ERROR,1000);
                ...
                case MSG_ERROR:
                    if (connectionListener != null) {
                        CallbackDelivery.i().post(new RESConnectionListener.RESWriteErrorRunable(connectionListener, 9));
                    }
                    break;
                default:
                    break;
