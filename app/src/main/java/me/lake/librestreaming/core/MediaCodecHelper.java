...
//            }
    ...
    public static MediaCodec createSoftVideoMediaCodec(MediaFormat videoFormat) {
        videoFormat.setString(MediaFormat.KEY_MIME, "video/avc");
        videoFormat.setInteger(MediaFormat.KEY_WIDTH, RESConfig.VIDEO_WIDTH);
        videoFormat.setInteger(MediaFormat.KEY_HEIGHT, RESConfig.VIDEO_HEIGHT);
